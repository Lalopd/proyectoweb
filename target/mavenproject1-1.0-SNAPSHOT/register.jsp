	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Este campo no puede estar vacío">
					...
					<div class="wrap-input100 validate-input" data-validate="La contraseña es necesaria">
						...
						<span class="label-input100">Contraseña</span>
                                ...
                                <div class="wrap-input100 validate-input" data-validate="La contraseña no es la misma">
